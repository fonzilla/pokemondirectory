...
router.get('/add', (req, res) => {
  ...
  res.render('form', { typeObj: typeObj, route:"/add", title: "Add New Pokemon"});
})
...
router.post('/delete', (req, res) => {
  Pokemon.findOneAndRemove({_id: req.body.button})
  .then((result)=>{
    console.log(result);
    res.redirect('/');
  })
...
router.get('/edit/:id', (req, res) => {
  ...
  .then((result) => {
    ...
    res.render('form', { result: result[0], typeObj: typeObj, route:"/update/", _id: req.params.id, title: "Edit A Pokemon"})
    // res.render('form', {})
  })
})
